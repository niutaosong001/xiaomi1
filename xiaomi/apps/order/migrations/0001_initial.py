    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('update_time', models.DateTimeField(verbose_name='更新时间', auto_now=True)),
                ('is_delete', models.BooleanField(verbose_name='删除标记', default=False)),
                ('order_num', models.CharField(verbose_name='订单号', primary_key=True, max_length=128, serialize=False)),
                ...
                ('comment', models.CharField(verbose_name='订单评论', max_length=256, default='')),
            ],
            options={
                'verbose_name': '订单信息',
